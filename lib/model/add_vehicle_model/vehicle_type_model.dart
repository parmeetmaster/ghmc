...
class VehicleTypeModel {
  ...
  factory VehicleTypeModel.fromJson(Map<String, dynamic> json) => VehicleTypeModel(
    ...
    data: List<VehicleTypeDataItem>.from(json["data"].map((x) => VehicleTypeDataItem.fromJson(x))),
  );
...
class VehicleTypeDataItem {
  ...
  factory VehicleTypeDataItem.fromRawJson(String str) => VehicleTypeDataItem.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory VehicleTypeDataItem.fromJson(Map<String, dynamic> json) => VehicleTypeDataItem(
    id: json["id"],
    name: json["name"],
  );
